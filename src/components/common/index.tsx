...
export function ScreenContainer({ children, title, subtitle, scrollable = true, noPadding }: ScreenContainerProps) {
  const { isDesktop, pagePadding } = useResponsive();

  const content = (
    <View style={[styles.container, noPadding && styles.noPadding, { paddingTop: isDesktop ? spacing.lg : spacing.md }]}>
      {title ? (
    ...
    return (
      <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView
          ...
          contentContainerStyle={[styles.scroll, { paddingBottom: isDesktop ? spacing.xxl : spacing.xxl }]}
